...
class GatewayConfigModeTests(unittest.TestCase):
    def test_gateway_mode_presets_resolve_expected_hosts_and_exposure(self):
        ...
        self.assertEqual(gateway_mode_defaults("loopback")["exposure"], "loopback-only")
        self.assertEqual(gateway_mode_defaults("lan")["host"], "0.0.0.0")
        self.assertEqual(gateway_mode_defaults("lan")["exposure"], "lan-only")
        self.assertEqual(gateway_mode_defaults("exposed")["host"], "0.0.0.0")
        self.assertEqual(gateway_mode_defaults("exposed")["exposure"], "remote")
